document.addEventListener('DOMContentLoaded', function () {
    ...
    const modal_eliminar = document.getElementById('modal_eliminar_departamento');
    const modal_eliminar_departamento = new bootstrap.Modal(modal_eliminar);
    ...
    document.querySelectorAll('.btn-eliminar').forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        modal_eliminar_departamento.show(); //Mostramos el modal
      });
    });
